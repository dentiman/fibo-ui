...
import { SelectDate, Popover, PopoverTriggerClick, PortalContent, FormFieldDirective } from '@fibo-ui/cdk';
import { Calendar } from '@fibo-ui/components';
import { LucideAngularModule } from 'lucide-angular';

@Component({
  selector: 'datepicker-signal-forms-example',
  imports: [FormField, FormFieldDirective, Popover, PortalContent, PopoverTriggerClick, Calendar, SelectDate, LucideAngularModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <div class="mx-auto p-8 w-[350px]">
      <form class="space-y-4">
        <div fiboFormField fiboPopoverTriggerClick class="form-field-control flex items-center gap-2">
