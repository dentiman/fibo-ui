...
@Component({
  selector: 'app-field-shell-examples-page',
  imports: [FormExample, LabelLayout, Size],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <div class="max-w-7xl mx-auto p-6 space-y-10">
      <div class="space-y-1">
        <h1 class="text-2xl font-bold text-foreground">Field Shell Examples</h1>
        <p class="text-sm text-foreground-secondary">
          Direct field-control examples rendered across size and label-layout combinations.
        </p>
      </div>
...
export class FieldShellExamplesPageComponent {}
